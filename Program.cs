...
namespace PatternsStude
{
    ...
    class Program
    {
        static void Main()
        {
            ...
            // Adding dummy data
            repository.AddStudent(new Student { Name = "Sweta Halder", ClassAndSection = "ClassA" });
            repository.AddStudent(new Student { Name = "Priya Biswas", ClassAndSection = "ClassA" });
            repository.AddStudent(new Student { Name = "Riya Saha", ClassAndSection = "ClassA" });
            repository.AddStudent(new Student { Name = "Sourav Dev", ClassAndSection = "ClassB" });            
            repository.AddStudent(new Student { Name = "Tania Mondal", ClassAndSection = "ClassA" });
            repository.AddStudent(new Student { Name = "Ayan", ClassAndSection = "ClassB" });
            repository.AddStudent(new Student { Name = "Sai Sanjay", ClassAndSection = "ClassB" });
            repository.AddStudent(new Student { Name = "Hasini", ClassAndSection = "ClassB" });
